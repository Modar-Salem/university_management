                ...
                <div class="col-lg-5 col-md-5 col-12">
                    <div class="bg-white rounded10 shadow-lg">
                        <div class="content-top-agile p-20 pb-0">
                            ...
                            <p class="mb-0">Sign in to continue to lecturer Dashboard.</p>
                        </div>
                        <div class="p-40">
                            <form action="{{ route('lecturer.login.action') }}" method="post" >
                                @csrf
                                @if ($errors->any())
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0">Don't have an account? <a href="{{route('lecturer.register')}}" class="text-warning ms-5">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
