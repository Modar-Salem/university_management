            ...
            <div class="row justify-content-center g-0">
                <div class="col-lg-5 col-md-5 col-12">
                    <div class="bg-white rounded10 shadow-lg">
                        ...
                        <div class="p-40">
                            <form action="{{ route('lecturer.register.save') }}" id="registerForm" method="post">
                            @csrf  <!-- CSRF token for security -->
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text bg-transparent"><i class="ti-email"></i></span>
                                        <input type="text" class="form-control ps-15 bg-transparent" placeholder="Details" name="details">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0">Already have an account?<a href="{{route('lecturer.login')}}" class="text-danger ms-5"> Sign In </a></p>
                            </div>
                        </div>
