        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    ...
                    <a href="/main.html"><span class="text-white fw-bold">مرحباً {{\Illuminate\Support\Facades\Auth::guard('lecturer')->user()->name}}</span></a>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto ">
                        ...
                        <li class="nav-item dropdown" >
                            <a class="nav-link px-3 me-4 " href="/mark.html" role="button" >
                                <i class="bi bi-stack me-2"></i>
                                العلامات
                            </a>
                        ...
                        <li class="nav-item dropdown" >
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/add-exam.html">إضافة</a></li>
                                <li><a class="dropdown-item" href="/display-exam.html">عرض</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link px-3" href="/subject.html">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-3  " href="/program.html">
